<template>
  <div class="leading-relaxed shadow-lg mt-4">
    <h1 class="mb-4">Ce jeu a été créé par Bruno Follet-Locatelli</h1>
    <p>C'est un mélange entre un téléphone arabe et un jeu de dessin</p>
